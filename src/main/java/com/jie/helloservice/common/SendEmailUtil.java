...
public class SendEmailUtil {
    ...
    private static String account = "2397569576@qq.com";    //登录用户名
    private static String pass = "lnbircmziqzkebdh";        //登录密码
    private static String host = "smtp.qq.com";        //服务器地址（邮件服务器）
    private static String port = "587";        //端口
